...
//!! CHALLENEGE 
//if the weapon equals fists then change the inner html of column3 to say "<p>you are using fists" 
//else if the weapon equals Squids then give a different message 
//otherwise (else)
...
document.getElementById("column3").innerHTML += "<p>you are using squids</p>";
    ...
    document.getElementById("column3").innerHTML += "<p>you are using something else twin</p>";
}
