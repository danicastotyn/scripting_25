...
function storageBuild(){
    console.log("Stoarge Unit is working!");
    buildings++;
    document.getElementById("city").innerHTML ="You have "+buildings+" buildings in your city!";
...
function randomBuild(){
    console.log("Random Building is working!");
    buildings++;
    document.getElementById("city").innerHTML ="You have "+buildings+" buildings in your city!";
    document.getElementById("cityGraphic").innerHTML +="<img src='images/BuildingBlock3.png' alt='Random Building'>";
}

//fourth button
function bigBuild(){
     console.log("Big Building is working!");
    buildings++;
    document.getElementById("city").innerHTML ="You have "+buildings+" buildings in your city!";
    document.getElementById("cityGraphic").innerHTML +="<img src='images/BuildingBlock4.png' alt='Big Building'>";
}